...
public class CeuwTestContainer extends TestContainer {

    public CeuwTestContainer() {
        super();
        ...
        appPropertiesFiles = Arrays.asList(
                ...
                "de/diedavids/cuba/ceuw/app.properties",
    ...
    public static class Common extends CeuwTestContainer {

        public static final CeuwTestContainer.Common INSTANCE = new CeuwTestContainer.Common();
